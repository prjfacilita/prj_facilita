                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="solicitation-register__form">
                                            ...
                                            <form action="{{route('pedido_emprestimo_parte01')}}" class="pedido_emprestimo_parte01" id="pedido_emprestimo_parte01" method="post" >
                                                {{ csrf_field() }}
                                                <div class="col-sm-10">
                                                    <label>Nome: <input type="text" id="solicitation_name" name="solicitation-name" class="solicitation-form__name solicitation-input" value="{{{ $data['data_cadastro']['nome_completo'] or  ""}}}" onkeypress="return this.value.length<=30 " required></label>
                                                </div>
