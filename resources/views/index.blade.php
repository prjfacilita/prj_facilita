                ...
                <div class="col-sm-4 banner__simulation simulation-value">
                    <div class="simulation-box">
                        ...
                        <form class="pt1" id="part-1-simulation" id="pt1" name="part-1-simulation" >
                            ...
                            <input type="text" name="simulation-other-value" placeholder="Outro valor" class="simulation-other-value" onkeydown="return formatReal( ( event.ctrlKey || event.altKey
